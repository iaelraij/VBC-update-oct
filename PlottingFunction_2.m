...
function PlottingFunction_2(folderName,finalresults_1,finalresults_2,resultsSolLongR_1,resultsSolLongR_2,var1,var2)
...
legend(['Ca ' var1],['Mg ' var1],['Na ' var1],['K ' var1],['SO4 ' var1],...
    ...
    ['SO4 ' var2],['Cl ' var2],'location','eastoutside')
...
scatter(1:size(finalresults_2(days(i)+1).general_data(:,1),1),(finalresults_2(days(i)+1).general_data(:,11)),'marker','*',...
    'markeredgecolor',color2)
scatter(1:size(finalresults_1(days(i)+1).general_data(:,1),1),finalresults_1(days(i)+1).general_data(:,11),'marker','*',...
...
legend(['pH Soil 1 cm ' var1],['pH Soil 1 cm ' var2],['pH Soil 2 cm ' var1],['pH Soil 2 cm ' var2],['pH Scup' var1],['pH Scup ' var2],...
    'location','best')
