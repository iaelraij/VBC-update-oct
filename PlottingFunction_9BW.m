...
function PlottingFunction_9BW(folderName,finalresults_1,finalresults_2,...
    finalresults_3,finalresults_4,finalresults_5,finalresults_6,...
    finalresults_7,finalresults_8,finalresults_9,...
    resultsSolLongR_1,resultsSolLongR_2,resultsSolLongR_3,resultsSolLongR_4,...
    resultsSolLongR_5, resultsSolLongR_6,resultsSolLongR_7,resultsSolLongR_8,...
    resultsSolLongR_9,var1,var2,var3,var4,var5,var6,var7,var8,var9)
%%
...
[seepC_7,ScupC_7,time_7,general_data_7,ScupCf_7,timeF_7,obsNodf_7,...
    Ca_7,K_7,Cl_7,Mg_7,Na_7,S_7,PHcup_7,PHsoil_7,calcite_7,gypsum_7,...
    timePhreeqcLong_7,CaLong_7,KLong_7,ClLong_7,MgLong_7,NaLong_7,...
    SLong_7,v_mean_7,ObsNlong_7,avgObsNlong_7,obsNchem_7,ScupChem_7,...
    SeepQ_7,Scupmeqcm7_7,SoluteBal_7]...
    =readResultsFinal(finalresults_7,resultsSolLongR_7);

[seepC_8,ScupC_8,time_8,general_data_8,ScupCf_8,timeF_8,obsNodf_8,...
    Ca_8,K_8,Cl_8,Mg_8,Na_8,S_8,PHcup_8,PHsoil_8,calcite_8,gypsum_8,...
    timePhreeqcLong_8,CaLong_8,KLong_8,ClLong_8,MgLong_8,NaLong_8,...
    SLong_8,v_mean_8,ObsNlong_8,avgObsNlong_8,obsNchem_8,ScupChem_8,...
    SeepQ_8,Scupmeqcm7_8,SoluteBal_8]...
    =readResultsFinal(finalresults_8,resultsSolLongR_8);

[seepC_9,ScupC_9,time_9,general_data_9,ScupCf_9,timeF_9,~,...
    Ca_9,K_9,Cl_9,Mg_9,Na_9,S_9,PHcup_9,PHsoil_9,calcite_9,gypsum_9,...
    timePhreeqcLong_9,CaLong_9,KLong_9,ClLong_9,MgLong_9,NaLong_9,...
    SLong_9,v_mean_9,ObsNlong_9,avgObsNlong_9,obsNchem_9,ScupChem_9,...
    SeepQ_9,Scupmeqcm7_9,SoluteBal_9]...
    =readResultsFinal(finalresults_9,resultsSolLongR_9);
...
[Ca_4,Mg_4,Na_4,K_4,S_4,Cl_4,AvgRel_4,SoluteBal_4,PHsoil_4,PHrel_4]=avgSubreg(Ca_4,Mg_4,Na_4,K_4,S_4,Cl_4,subVol(1,:),SoluteBal_4,PHsoil_4,PHcup_4);
[Ca_5,Mg_5,Na_5,K_5,S_5,Cl_5,AvgRel_5,SoluteBal_5,PHsoil_5,PHrel_5]=avgSubreg(Ca_5,Mg_5,Na_5,K_5,S_5,Cl_5,subVol(1,:),SoluteBal_5,PHsoil_5,PHcup_5);
[Ca_6,Mg_6,Na_6,K_6,S_6,Cl_6,AvgRel_6,SoluteBal_6,PHsoil_6,PHrel_6]=avgSubreg(Ca_6,Mg_6,Na_6,K_6,S_6,Cl_6,subVol(1,:),SoluteBal_6,PHsoil_6,PHcup_6);
[Ca_7,Mg_7,Na_7,K_7,S_7,Cl_7,AvgRel_7,SoluteBal_7,PHsoil_7,PHrel_7]=avgSubreg(Ca_7,Mg_7,Na_7,K_7,S_7,Cl_7,subVol(1,:),SoluteBal_7,PHsoil_7,PHcup_7);
[Ca_8,Mg_8,Na_8,K_8,S_8,Cl_8,AvgRel_8,SoluteBal_8,PHsoil_8,PHrel_8]=avgSubreg(Ca_8,Mg_8,Na_8,K_8,S_8,Cl_8,subVol(1,:),SoluteBal_8,PHsoil_8,PHcup_8);
[Ca_9,Mg_9,Na_9,K_9,S_9,Cl_9,AvgRel_9,SoluteBal_9,PHsoil_9,PHrel_9]=avgSubreg(Ca_9,Mg_9,Na_9,K_9,S_9,Cl_9,subVol(1,:),SoluteBal_9,PHsoil_9,PHcup_9);
...
scatter(timeF_7(:,2),PHsoil_7(:,2),'filled','markerfacecolor',color7)
scatter(timeF_8(:,2),PHsoil_8(:,2),'filled','markerfacecolor',color8)
scatter(timeF_9(:,2),PHsoil_9(:,2),'filled','markerfacecolor',color9)
...
scatter(timeF_7(:,2),PHcup_7(:),'markeredgecolor',color7)
scatter(timeF_8(:,2),PHcup_8(:),'markeredgecolor',color8)
scatter(timeF_9(:,2),PHcup_9(:),'markeredgecolor',color9)
ylim(pHlim)
legend1=legend(['Soil ' var1],['Soil ' var2],['Soil ' var3],['Soil ' var4],...
    ['Soil ' var5],['Soil ' var6],['Soil ' var7], ['Soil ' var8],['Soil ' var9],...
['Scup' var1],['Scup ' var2],['Scup ' var3],['Scup ' var4],['Scup ' var5],...
['Scup ' var6],['Scup ' var7],['Scup ' var8],['Scup ' var9],'location','best');
set(legend1,...
...
ylabel('Volume (cm^{3})' ,'FontSize', 12, 'FontName','Arial')
set(gca,'FontSize',12);
...
hold on
box on
time9=0:(size(finalresults_9(3).general_data(:,1),1));
time9=time9;
scatter(time9,[0; finalresults_9(3).general_data(:,4)],'markeredgecolor','k','marker','*')
time8=0:(size(finalresults_8(3).general_data(:,1),1));
time8=time8;
scatter(time8,[0; finalresults_8(3).general_data(:,4)],'markeredgecolor','k','marker','o')
time7=0:(size(finalresults_7(3).general_data(:,1),1));
time7=time7;
scatter(time7,[0; finalresults_7(3).general_data(:,4)],'markeredgecolor','k','marker','.')
xlabel('TAV (min)' ,'FontSize', 12, 'FontName','Arial')
ylabel('Volume (cm^{3})' ,'FontSize', 12, 'FontName','Arial')
set(gca,'FontSize',12);
ylim([0 500])
legend('5000 cm^3','500 cm^3','100 cm^3','Location','southeast')
legend('boxoff')
%%
subplot(2,3,4)
hold on 
...
scatter(time3,[-250;finalresults_3(3).general_data(:,5)],'markeredgecolor','k','marker','*')
scatter(time2,[-250;finalresults_2(3).general_data(:,5)],'markeredgecolor','k','marker','o')
scatter(time1,[-250;finalresults_1(3).general_data(:,5)],'markeredgecolor','k','marker','.')
xlabel('TAV (min)' ,'FontSize', 12, 'FontName','Arial')
ylabel('Pressure (cm)' ,'FontSize', 12, 'FontName','Arial')
set(gca,'FontSize',12);
...
hold on
box on
time9=0:size(finalresults_9(3).general_data(:,1));
time8=0:size(finalresults_8(3).general_data(:,1));
time7=0:size(finalresults_7(3).general_data(:,1));
scatter(time9,[-813;finalresults_9(3).general_data(:,5)],'markeredgecolor','k','marker','*')
scatter(time8,[-813;finalresults_8(3).general_data(:,5)],'markeredgecolor','k','marker','o')
scatter(time7,[-813;finalresults_7(3).general_data(:,5)],'markeredgecolor','k','marker','.')
xlabel('TAV (min)' ,'FontSize', 12, 'FontName','Arial')
ylabel('Pressure (cm)' ,'FontSize', 12, 'FontName','Arial')
set(gca,'FontSize',12);
...
saveas(hb, [folder '\' answer{1} '\dPH9.jpg'])
...
xlabel('dPH' ,'FontSize', 14, 'FontName','Arial')
ylabel('dt (min)' ,'FontSize', 14, 'FontName','Arial')
saveas(h, [folder '\' answer{1} '\dtdPH.jpg'])
...
saveas(h1, [folder '\' answer{1} '\dPH.jpg'])
...
saveas(h2, [folder '\' answer{1} '\dt.jpg'])
