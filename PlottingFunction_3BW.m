...
function PlottingFunction_3BW(folderName,finalresults_1,finalresults_2,...
    finalresults_3,resultsSolLongR_1,resultsSolLongR_2,resultsSolLongR_3,...
    var1,var2,var3)
color1='k';%[0 0.4470 0.7410];
color2='k';%[0.635 0.078 0.184 ];
color3='k';%[0.4660 0.6740 0.1880 ];
color4='r';
color5='r';
color6='r';
pHlim=[6 8.3];
...
scatter(timeF_1(:,2),PHsoil_1(:,2),'marker','o','markerfacecolor',color1,'markeredgecolor',color1)
hold on
box on
scatter(timeF_2(:,2),PHsoil_2(:,2),'marker','s','markerfacecolor',color2,'markeredgecolor',color2)
scatter(timeF_3(:,2),PHsoil_3(:,2),'marker','d','markerfacecolor',color3,'markeredgecolor',color3)
scatter(timeF_4(:,2),PHsoil_4(:,2),'marker','o','markerfacecolor',color4,'markeredgecolor',color4)
scatter(timeF_5(:,2),PHsoil_5(:,2),'marker','s','markerfacecolor',color5,'markeredgecolor',color5)
scatter(timeF_6(:,2),PHsoil_6(:,2),'marker','d','markerfacecolor',color6,'markeredgecolor',color6)
scatter(timeF_1(:,2),PHcup_1(:),'marker','o','markeredgecolor',color1)
scatter(timeF_2(:,2),PHcup_2(:),'marker','s','markeredgecolor',color2)
scatter(timeF_3(:,2),PHcup_3(:),'marker','d','markeredgecolor',color3)
scatter(timeF_4(:,2),PHcup_4(:),'marker','o','markeredgecolor',color4)
scatter(timeF_5(:,2),PHcup_5(:),'marker','s','markeredgecolor',color5)
scatter(timeF_6(:,2),PHcup_6(:),'marker','d','markeredgecolor',color6)
ylim(pHlim)
xlim([0 12])
...
time3=time3;
scatter(time3,[0; finalresults_3(3).general_data(:,4)],'marker','*','markeredgecolor',color3)
time2=0:(size(finalresults_2(3).general_data(:,1),1));
time2=time2;
scatter(time2,[0; finalresults_2(3).general_data(:,4)],'marker','.','markeredgecolor',color2)
time1=0:(size(finalresults_1(3).general_data(:,1),1));
time1=time1;
scatter(time1,[0;finalresults_1(3).general_data(:,4)],'marker','o','markeredgecolor',color1)
...
hold on
box on
time3=0:size(finalresults_6(3).general_data(:,1));
time2=0:size(finalresults_5(3).general_data(:,1));
time1=0:size(finalresults_4(3).general_data(:,1));
scatter(time3,[-813;finalresults_6(3).general_data(:,5)],'marker','*','markeredgecolor',color3)
scatter(time2,[-813;finalresults_5(3).general_data(:,5)],'marker','.','markeredgecolor',color2)
scatter(time1,[-813;finalresults_4(3).general_data(:,5)],'marker','o','markeredgecolor',color1)
xlabel('TAV (min)' ,'FontSize', 14, 'FontName','Arial')
...
hold on
box on
time3=0:(size(finalresults_6(3).general_data(:,1),1));
time3=time3;
scatter(time3,[0; finalresults_6(3).general_data(:,4)],'marker','*','markeredgecolor',color3)
time2=0:(size(finalresults_5(3).general_data(:,1),1));
time2=time2;
scatter(time2,[0; finalresults_5(3).general_data(:,4)],'marker','.','markeredgecolor',color2)
time1=0:(size(finalresults_4(3).general_data(:,1),1));
time1=time1;
scatter(time1,[0;finalresults_4(3).general_data(:,4)],'marker','o','markeredgecolor',color1)
xlabel('TAV (min)' ,'FontSize', 14, 'FontName','Arial')
ylabel('Volume (cm^{3})' ,'FontSize', 14, 'FontName','Arial')
set(gca,'FontSize',14);
...
scatter(time3,[-500;finalresults_3(3).general_data(:,5)],'marker','*','markeredgecolor',color3)
scatter(time2,[-500;finalresults_2(3).general_data(:,5)],'marker','.','markeredgecolor',color2)
scatter(time1,[-500;finalresults_1(3).general_data(:,5)],'marker','o','markeredgecolor',color1)
xlabel('TAV (min)' ,'FontSize', 14, 'FontName','Arial')
ylabel('Pressure (cm)' ,'FontSize', 14, 'FontName','Arial')
set(gca,'FontSize',14);
%legend('LF200','2','1','location','southeast')
