function finalresultsI=resultsInitial(fnameI,obsNnodes)
folder=pwd;
ObsN=obsNod([folder fnameI],1,obsNnodes);
...
finalresultsI=struct('name', fnameI, 'general_data', 0,'atmosph',atmosph,'v_mean',v_mean,'cupConc',ScupC,'ObsN',ObsN,'pHnodes',0,'seepConc',seepC,'irrConc',irrC,'phreeqcAll', 0,'balance',0);
end