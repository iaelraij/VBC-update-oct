...
function PlottingFunction_6(folderName,finalresults_1,finalresults_2,...
...
time6=time6;
scatter(time6,[0; finalresults_6(3).general_data(:,4)],'markeredgecolor',color6)
time5=0:(size(finalresults_5(3).general_data(:,1),1));
time5=time5;
scatter(time5,[0; finalresults_5(3).general_data(:,4)],'markeredgecolor',color5)
...
scatter(time6,[-500;finalresults_6(3).general_data(:,5)],'markeredgecolor',color6)
scatter(time5,[-500;finalresults_5(3).general_data(:,5)],'markeredgecolor',color5)
