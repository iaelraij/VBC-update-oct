...
function PlottingFunction_6BW(folderName,finalresults_1,finalresults_2,...
...
time3=time3;
scatter(time3,[0; finalresults_3(3).general_data(:,4)],'markeredgecolor',color2,'marker','*')
time2=0:(size(finalresults_2(3).general_data(:,1),1));
time2=time2;
scatter(time2,[0; finalresults_2(3).general_data(:,4)],'markeredgecolor',color2,'marker','o')
time1=0:(size(finalresults_1(3).general_data(:,1),1));
time1=time1;
scatter(time1,[0;finalresults_1(3).general_data(:,4)],'markeredgecolor',color2,'marker','.')
...
scatter(time3,[-500;finalresults_3(3).general_data(:,5)],'markeredgecolor',color2,'marker','*')
scatter(time2,[-500;finalresults_2(3).general_data(:,5)],'markeredgecolor',color2,'marker','o')
scatter(time1,[-500;finalresults_1(3).general_data(:,5)],'markeredgecolor',color2,'marker','.')
xlabel('TAV (min)' ,'FontSize', 14, 'FontName','Arial')
ylabel('Pressure (cm)' ,'FontSize', 14, 'FontName','Arial')
set(gca,'FontSize',14);
legend(var6,var5,var4,var3,var2,var1,'Location','southeast')
