...
function[]=domain_initialWash(fname,fnameI,runN,nodes,P1)
folder=pwd;
P1={num2str(P1)};
...
fid = fopen([folder fname runN '\DOMAIN.dat'], 'r');%CHECK that this file is updated!!!
i = 1;
lines{i} = fgets(fid);
...
fid = fopen([folder fname runN '\DOMAIN.dat'], 'w');
