function [nextSim]=runInitial(initial,washRun,atmosphAll,nodes)
...
fclose(options);
%%======================================================================%%
%import the pressure head initial conditions from the wash simulation
domain_initialWash(initial,washRun,'',nodes,0);
